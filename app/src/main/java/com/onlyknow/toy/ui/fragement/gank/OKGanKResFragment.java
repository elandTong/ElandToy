...
public class OKGanKResFragment extends OKBaseFragment implements OnRefreshListener, OnLoadMoreListener {
    ...
    public OKGanKResFragment(int colorId) {
        super(colorId);
    }
    ...
    public void onLoadMore(RefreshLayout refreshLayout) {
        if (OKNetUtil.isNet(getActivity())) {
            OKLoadGanKApi.Params pam = mOKLoadGanKApi.getLastParam().setType(OKLoadGanKApi.Params.TYPE_RS).setPageCount(++page);
    ...
    public void onRefresh(RefreshLayout refreshLayout) {
        if (OKNetUtil.isNet(getActivity())) {
            OKLoadGanKApi.Params pam = mOKLoadGanKApi.getLastParam().setType(OKLoadGanKApi.Params.TYPE_RS).setPageCount(1);
