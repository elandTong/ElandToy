...
public class OKGanKAndroidFragment extends OKBaseFragment implements OnRefreshListener, OnLoadMoreListener {
    ...
    public OKGanKAndroidFragment(int colorId) {
        super(colorId);
    }
    ...
    public void onLoadMore(@NonNull RefreshLayout refreshLayout) {
        if (OKNetUtil.isNet(getActivity())) {
            OKLoadGanKApi.Params pam = mOKLoadGanKApi.getLastParam().setType(OKLoadGanKApi.Params.TYPE_AN).setPageCount(++page);
    ...
    public void onRefresh(@NonNull RefreshLayout refreshLayout) {
        if (OKNetUtil.isNet(getActivity())) {
            OKLoadGanKApi.Params pam = mOKLoadGanKApi.getLastParam().setType(OKLoadGanKApi.Params.TYPE_AN).setPageCount(1);
