...
public class OKGanKRecommendFragment extends OKBaseFragment implements OnRefreshListener, OnLoadMoreListener {
    ...
    public OKGanKRecommendFragment(int colorId) {
        super(colorId);
    }
    ...
    public void onLoadMore(RefreshLayout refreshLayout) {
        if (OKNetUtil.isNet(getActivity())) {
            OKLoadGanKApi.Params pam = mOKLoadGanKApi.getLastParam().setType(OKLoadGanKApi.Params.TYPE_RECOMMEND).setPageCount(++page);
    ...
    public void onRefresh(RefreshLayout refreshLayout) {
        if (OKNetUtil.isNet(getActivity())) {
            OKLoadGanKApi.Params pam = mOKLoadGanKApi.getLastParam().setType(OKLoadGanKApi.Params.TYPE_RECOMMEND).setPageCount(1);
