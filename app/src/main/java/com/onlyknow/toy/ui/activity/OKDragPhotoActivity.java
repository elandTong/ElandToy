...
import com.onlyknow.toy.component.view.OKDragPhotoView;
import com.onlyknow.toy.component.view.OKProgressButton;
...
public class OKDragPhotoActivity extends OKBaseActivity implements RequestListener {
    ...
    private OKNetUtil mWebService;

    private Bundle mBundle;
    private String url = "";

    private void init() {
        GlideApp.with(this).load(url).placeholder(R.drawable.ok_gank_item).listener(this).into(okActivityDragPhoto);
        ...
        okActivityDragPhotoDown.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mWebService = OKNetUtil.getInstance();
    ...
    // 下载回调类
    private class DownloadCallback extends OKNetUtil.ResultCallback {
        @Override
