...
public class OKGanKAppFragment extends OKBaseFragment implements OnRefreshListener, OnLoadMoreListener {
    ...
    public OKGanKAppFragment(int colorId) {
        super(colorId);
    }
    ...
    public void onLoadMore(@NonNull RefreshLayout refreshLayout) {
        if (OKNetUtil.isNet(getActivity())) {
            OKLoadGanKApi.Params pam = mOKLoadGanKApi.getLastParam().setType(OKLoadGanKApi.Params.TYPE_APP).setPageCount(++page);
    ...
    public void onRefresh(@NonNull RefreshLayout refreshLayout) {
        if (OKNetUtil.isNet(getActivity())) {
            OKLoadGanKApi.Params pam = mOKLoadGanKApi.getLastParam().setType(OKLoadGanKApi.Params.TYPE_APP).setPageCount(1);
