package com.onlyknow.toy.utils.transform;
...
public class OKIconTransformation implements Transformation<Bitmap> {
    private Context mContext;
    private BitmapPool mBitmapPool;

    private OKIconTransformation(Context context) {
    ...
    private Bitmap addIcon(Bitmap toTransform) {
        ...
        Bitmap iconBitmap = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.ok_play);
        if (iconBitmap == null) {
            return toTransform;
        }
